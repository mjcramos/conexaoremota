  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Chat_RichEdit.SelStart := Chat_RichEdit.GetTextLen;
        Chat_RichEdit.SelAttributes.Style := [fsBold];
        Chat_RichEdit.SelAttributes.Color := clBlack;
        Chat_RichEdit.SelText := #13 + #13 + apelido+' Falou:' + #13;
        Chat_RichEdit.SelStart := Chat_RichEdit.GetTextLen;
      ...
      frm_main.Main_Socket.Socket.SendText(ansistring('<|REDIRECT|><|CHAT|>' + YourText_Edit.Text + '<|END|>'));
      YourText_Edit.Clear;
