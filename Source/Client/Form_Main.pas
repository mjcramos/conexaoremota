...
var
  ...
  id_cliente      : string;
  loscomputer     : string;
  MousePosXX, MousePosYY : integer;
  senha_cliente   : string;
  apelido         : string;
  debug           : string;

const
  Host = '192.168.1.199'; // ''; Host of Sockets  (Insert the IP Address or DNS of your Server)
...
//////////////////////////
      If Not((MousePosX = MousePosXX) And
        (MousePosY = MousePosYY)) Then
      Begin
        MousePosXX := MousePosX;
        MousePosYY := MousePosY;
    ...
    begin
      ...
      begin
        if MouseAction = 'D' then
          mouse_event(MOUSEEVENTF_ABSOLUTE or MOUSEEVENTF_LEFTDOWN, MousePosX, MousePosY, 0, 0)
          ...
          Mouse_Event(MOUSEEVENTF_ABSOLUTE or MOUSEEVENTF_MIDDLEUP, MousePosX, MousePosY, 0, 0);
      end else if MouseEvent = 'R' then
      begin
        if MouseAction = 'D' then
          mouse_event(MOUSEEVENTF_ABSOLUTE or MOUSEEVENTF_RIGHTDOWN, MousePosX, MousePosY, 0, 0)
        else if MouseAction = 'U' then
          mouse_event(MOUSEEVENTF_ABSOLUTE or MOUSEEVENTF_RIGHTUP, MousePosX, MousePosY, 0, 0)
        else if MouseAction = 'X' then
          Mouse_Event(MOUSEEVENTF_ABSOLUTE or MOUSEEVENTF_MIDDLEDOWN, MousePosX, MousePosY, 0, 0);
      end;
    end;
